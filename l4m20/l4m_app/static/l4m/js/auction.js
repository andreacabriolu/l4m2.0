...
function openPlayerDialog(player) {
    ...
    var balance_for_bets = $('#balance_for_bets').val();
    ...
    $('#modal-label-bet').html($('#modal-label-bet').html()
        .replace('_minbet_', player.betamount != 'None' ? '<strong>player.betamount+1</strong>' : '<strong>1</strong>')
