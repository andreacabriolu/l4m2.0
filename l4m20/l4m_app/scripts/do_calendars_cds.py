...
# cur.execute('SELECT team_id, series_id FROM "l4m_app_team_Series" where series_id IN (21, 22);')
# cur.execute('SELECT team_id, series_id FROM "l4m_app_team_Series" where series_id IN (23, 24);')
cur.execute('SELECT team_id, series_id FROM "l4m_app_team_Series" where series_id IN (25, 26);')
rows = cur.fetchall()
...
output_file = "matches_inserts_cds.2.sql"        
insert_statements = []

# ~ # --- Part 1: CompetitionCalendar inserts (35 days) ---
# ~ for day in range(11, 13, 1):
    # ~ stmt = (
