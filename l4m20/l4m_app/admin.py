...
admin.site.register(competition_calendar.CompetitionCalendar)
admin.site.register(other_competition.OtherCompetition)
admin.site.register(quarantine.Quarantine)